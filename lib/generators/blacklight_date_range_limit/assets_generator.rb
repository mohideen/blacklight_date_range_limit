# Copy BlacklightDateRangeLimit assets to public folder in current app.
...
#       require File.join(BlacklightDateRangeLimit.root, "lib", "generators", "blacklight", "assets_generator.rb")
#       BlacklightDateRangeLimit::AssetsGenerator.start(["--force", "--quiet"])
...
module BlacklightDateRangeLimit
  class AssetsGenerator < Rails::Generators::Base
    source_root File.join(BlacklightDateRangeLimit::Engine.root, 'app', 'assets')
...
%q{
 *
 * Used by blacklight_date_range_limit
...
// For blacklight_date_range_limit built-in JS, if you don't want it you don't need
// this:
//= require 'blacklight_date_range_limit'
