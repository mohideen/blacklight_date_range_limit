...
module BlacklightDateRangeLimit
  module DateRangeLimitBuilder
    ...
    include BlacklightDateRangeLimit::SegmentCalculation
    ...
    # it is specifically swapped in *instead of* add_date_range_limit_params for
    ...
    # date_range_field, date_range_start, date_range_end
